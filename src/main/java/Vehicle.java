public class Vehicle {
    ...
    public int computeDeltaV() {
        return Velocity + Gravity - Burn;  // return velocity + gravity - burn amount
    ...
    public void adjustForBurn(int burnAmount) {
        ...
        this.Velocity = computeDeltaV();  // set new velocity to result of computeDeltaV function.
    ...
    public DescentEvent getStatus(int tick) {
        ...
        DescentEvent desEvnt = new DescentEvent(tick, Velocity, Fuel, Altitude, Flying);
        return desEvnt;
    }
